...
- piping allows us to pass information from one command to another command
...
But we can do it using a loop, provided we get each filename on a separate line:
...
2. Turn the code into a function that also prints out the number of rows that are being removed.
