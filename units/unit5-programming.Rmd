...
languages may implement things differently. One of my goals here for us
...
within the R language, as seen in the section on [Computing on the Language](#computing-on-the-language).
...
regular expressions. In these examples, the first backslash says to
...
four following types: *logical*, *integer*, *double/numeric*, and
*character*.
